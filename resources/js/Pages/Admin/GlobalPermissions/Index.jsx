...
export default function Index({ subdivisions = [], permissions = {} }) {
    ...
    const submit = () => {
        ...
        router.post(
            route("global-permissions.store"),
            { permissions: payload },
            {
                onSuccess: () => {
                    Swal.fire({
    ...
    return (
        <AuthenticatedLayout
            user={auth?.user}
            header={
                <h2 className="font-semibold text-xl">Global Permissions</h2>
            }
        >
                ...
                <div className="py-12 w-full overflow-auto">
                    <div className="mx-auto p-6 lg:px-8">
                        <h1 className="text-2xl font-bold mb-3">
                            Global Permissions per Subdivision
                        </h1>
                        <p className="text-sm text-gray-600 mb-6">
                            Atur izin global untuk setiap subdivisi. Perubahan
                            ini berlaku untuk semua workflow.
                        </p>
